...
@Controller
public class StreetDeleteController {
    private final DataSource dataSource;

    @Autowired
    public StreetDeleteController(DataSource dataSource) {
        this.dataSource = dataSource;
    }

    @GetMapping("/street-delete")
    public String getStreetDeleteForm() {
        return "street-delete";
    }

    @PostMapping("/street-delete")
    public String deleteDepartment(@RequestParam("street_id") int id, Model model) {
